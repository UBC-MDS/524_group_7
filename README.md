...
- `close_up` - This function accepts a pandas dataframe and the number of pairs of variables with strongest correlations, and creates scatterplots with a linear trend for each pair of variables with stronglest correlations.
